...
import { GetBusinessInfoCardDocument } from '~/graphql/generated';

export const GetBusinessInfoCardQuery = gql(
  `query GetBusinessInfoCard($placeId: String!) {
...
const BusinessListScreen = () => {
  ...
  const { loading, error, data } = useQuery(GetBusinessInfoCardDocument, {
    variables: {
