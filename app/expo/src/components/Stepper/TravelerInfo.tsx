        ...
        {steps?.map((step, i) => (
          ...
          >
            ...
            <View style={styles.step}>
              ...
              <Text style={styles.stepText}>{stepInput[i].text}</Text>
              {stepInput[i].isCalendar ? (
                <TouchableOpacity>
                  {/* Render your calendar component here */}
                  <Text>Calendar Icon</Text>
                </TouchableOpacity>
              ) : stepInput[i].isMultiInput ? (
                <View>
                  {/* Render multiple input boxes here */}
                  <TextInput style={styles.multiInput} placeholder="Input 1" />
                  <TextInput style={styles.multiInput} placeholder="Input 2" />
                </View>
              ) : null}
            </View>
