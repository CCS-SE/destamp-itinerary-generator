...
export type GetAllTripsQuery = { __typename?: 'Query', trips: Array<{ __typename?: 'Trip', id: string, title: string, budget: number, travelSize: TravelSize, startDate: any, endDate: any, destination: { __typename?: 'Destination', name: string, image: { __typename?: 'Image', url: string } } }> };
